...
fp = 1.d0
TotalCarbo = 0.d0
IF(soil_carbon_i > 0.d0) TotalCarbo = soil_carbon_i
TotalNitro = 0.d0
IF(soil_nitrogen_i > 0.d0) TotalNitro = soil_nitrogen_i
TotalP = 0.d0
IF(soil_phosphorus_i > 0.d0) TotalP = soil_phosphorus_i
!Total_resp = 0.d0
alpha_temp = 0.d0
alpha_moist = 0.d0
dec_dpm_rpm(:) = 0.d0
...
minl_n_bio_pot(:) = 0.d0
minl_n_hum_pot(:) = 0.d0
immob_n_dpm_pot(:) = 0.d0
immob_n_rpm_pot(:) = 0.d0
immob_n_bio_pot(:) = 0.d0
immob_n_hum_pot(:) = 0.d0
minl_p_dpm_pot(:) = 0.d0
minl_p_rpm_pot(:) = 0.d0
minl_p_bio_pot(:) = 0.d0
minl_p_hum_pot(:) = 0.d0
immob_p_dpm_pot(:) = 0.d0
immob_p_rpm_pot(:) = 0.d0
immob_p_bio_pot(:) = 0.d0
immob_p_hum_pot(:) = 0.d0
soilC(:,:,:,:) = 0.d0
npr_soil = 10.d0
Q10_soil = 2.d0
psi_soil = 0.d0
