...
output(ii,:,11,1) = sum(soilC(ii,:,1,:))
output(ii,:,11,2) = sum(soilC(ii,:,2:3,:))
output(ii,:,11,3) = O_C
output(ii,:,11,4) = O_N
output(ii,:,11,5) = (Yl_Coutflux(:) + Yr_Coutflux(:))
output(ii,:,11,6) = O_Coutflux
...
else if (soil_model .eq. int(3)) then
output(ii,:,11,1) = Yl_C(:)
output(ii,:,11,2) = Yr_C(:)
output(ii,:,11,3) = soc
output(ii,:,11,4) = resp_dpm
output(ii,:,11,5) = resp_rpm
output(ii,:,11,6) = resp_soc
output(ii,:,11,7) = TotalCarbo
output(ii,:,11,8) = TotalNitro
output(ii,:,11,9) = Nav
output(ii,:,11,10) = Un(:)
output(ii,:,11,11) = Pav
output(ii,:,11,12) = TotalP
output(ii,:,11,13) = Total_resp
end if
