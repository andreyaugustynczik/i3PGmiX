...
! RothC soil model
real(kind=8), dimension(n_sp) :: dpm_ratio, kaps_roth_dpm,kaps_roth_rpm,kaps_roth_bio,kaps_roth_hum
real(kind=8), dimension(n_sp) :: cn_dpm, cn_rpm, cn_bio, cn_hum, cp_dpm, cp_rpm, cp_bio, cp_hum, lit_cn, lit_cp, cn_veg, cp_veg
real (kind=8) :: Q10_soil, alpha_moist, t_soil, sth_wilt, sth_opt, sth_resp_min, min_factor, alpha_temp, t_soil_surf
real (kind=8) :: k_dpm, k_rpm, k_bio, k_hum, soc_int, ns_int, ps_int, ns, ps
real (kind=8) :: nminl_gas, lch_dis, npr_soil, Pav, FRin_p, soilage_max
real(kind=8), dimension(n_sp) ::  Pcf, Pcr, Pcs
real(kind=8), dimension(4) :: compress_dr, compress_bh

real (kind=8), dimension(n_sp) ::  resp_dpm, resp_rpm, resp_bio, resp_hum, dec_dpm_rpm
real (kind=8), dimension(n_sp) :: cs_dpm, cs_rpm, cs_bio, cs_hum, ns_dpm, ns_rpm, ns_bio, ns_hum, n_inorg_f, dz_extra
!FOR NOW I SET dim_cslyr to 4
real (kind=8), dimension(n_sp,4) :: cs_dpm_dz, cs_rpm_dz, cs_bio_dz, cs_hum_dz
!FOR NOW I SET dim_cslyr to 4, the other 4 referes to CS pool
real (kind=8), dimension(n_sp,4,4) :: soilcarb_age_pool,  pc, cs, resp_s, resp_frac, dcs, mix_s, mix_term
real (kind=8), dimension(4) :: lit_frac, dzsoil, zz_l,soil_minvol_soilt_1pt, soil_minmass_soilt_1pt, f_org

!FOR NOW I SET dim_cslyr to 4, the 2 referes to plants N pools 
real (kind=8), dimension(n_sp,4,2) :: ns_dpm_rpm

real (kind=8) :: TotalCarbo_dz_10cm, TotalCarbo_dz_35cm, TotalCarbo_dz_100cm, TotalCarbo_dz_300cm
real (kind=8) :: Total_resp, soc, resp_soc, TotalP
real (kind=8), dimension(n_sp) :: minl_n_dpm_pot, minl_n_rpm_pot, minl_n_bio_pot, minl_n_hum_pot, minl_n_pot_tot, fn_l
real (kind=8), dimension(n_sp) :: minl_n_dpm, minl_n_rpm, minl_n_bio, minl_n_hum, minl_n_tot
real (kind=8), dimension(n_sp) :: immob_n_dpm_pot, immob_n_rpm_pot, immob_n_bio_pot, immob_n_hum_pot, immob_n_pot_tot
real (kind=8), dimension(n_sp) :: immob_n_dpm, immob_n_rpm, immob_n_bio, immob_n_hum, immob_n_tot
real (kind=8), dimension(n_sp) :: n_lch, n_gas, n_inorg_T, p_inorg_T
real (kind=8), dimension(n_sp) ::  ps_dpm, ps_rpm, ps_bio, ps_hum, p_lch, fp
real (kind=8), dimension(n_sp) :: minl_p_dpm_pot, minl_p_rpm_pot, minl_p_bio_pot, minl_p_hum_pot, minl_p_pot_tot
real (kind=8), dimension(n_sp) :: minl_p_dpm, minl_p_rpm, minl_p_bio, minl_p_hum, minl_p_tot
real (kind=8), dimension(n_sp) :: immob_p_dpm_pot, immob_p_rpm_pot, immob_p_bio_pot, immob_p_hum_pot, immob_p_pot_tot
real (kind=8), dimension(n_sp) :: immob_p_dpm, immob_p_rpm, immob_p_bio, immob_p_hum, immob_p_tot
