...
#'
#' @format A \code{data frame} with 1 rows and 14 variables:
#' \describe{
...
#'
#' @format A \code{data frame} with number of rows corresponding to each species/cohort and 19 variables:
#' \describe{
...
#'
#' @format A \code{data frame} with 156 rows and 14 variables:
#' \describe{
