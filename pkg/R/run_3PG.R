...
#'
#' @details `i3PGmiX` enhanced 3PGmix model, based on the r3PG package.i3PGmiX advances the representation of several processes in 3PGmix, including improved GPP and NPP computation, as well as modules for soil and disturbances.
#'
